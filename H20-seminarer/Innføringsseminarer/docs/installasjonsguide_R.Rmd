...
Før du går videre, ber jeg om at du installerer [R](https://cloud.r-project.org/) og [Rstudio](https://www.rstudio.com/products/rstudio/download/) (velg gratisversjonen for desktop). Følg lenkene, og kjør standardinstallasjonen for ditt operativsystem. Du kan også se på denne [installasjonsguiden](https://github.com/louisabo/STV4020A/blob/master/Nedlastningsguide.pdf). 
